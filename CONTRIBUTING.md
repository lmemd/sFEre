...
Following this procedure, everyone can see your changes and when his turn comes, pushing changes in main repo will not produce conflicts.
We all need to work on updated repos and not old ones.

Procedure: 1) Pull and rebase from remote to local.
           2) Commit and push to local.
           3) Push to remote.
