...
def visualize_velocity_distribution(velocities):
    ...
    showing the histogram as a percentage of total shots.

    Parameters:
        - velocities (list or array-like): List of velocity values generated by a stochastic function.
    ...
    total = sum(counts * (bins[1] - bins[0]))
