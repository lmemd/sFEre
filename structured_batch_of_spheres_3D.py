...
def main():
    ...
    (nodes, elements) = create_mesh_geometry("spherified_cube", "nonlinear", spheres, element_length, filename, directory,output_option = "LSDYNA") # process and output of meshed generated spheres
